...
abr_FIG.handle = figure('NumberTitle','off','Name','ABR peaks','Units','normalized','Visible','on',...
    'position',[0 0.03-shift 1 0.92],'outerposition',[0 0 1 1],'CloseRequestFcn','abr_analysis_HL(''close'');');
% colordef none;
whitebg('w');
...
abr_FIG.push.peaks = uicontrol(abr_FIG.handle,'callback','abr_analysis_HL(''peaks'');','style','pushbutton','Units','normalized','position',[0.35 .355 0.1260 .03],'string','Load Previous Peaks');

%Load ABR files push button
abr_FIG.push.process = uicontrol(abr_FIG.handle,'callback','abr_analysis_HL(''process'');','style','pushbutton','Units','normalized','position',[0.35 .32 0.1260 .03],'string','Load ABR Files');

%Show ref data push button
abr_FIG.push.refdata = uicontrol(abr_FIG.handle,'callback','abr_analysis_HL(''refdata'');','style','pushbutton','Units','normalized','position',[0.35 .285 0.1260 .03],'string','Load Reference Data');
...
%template checkbox
han.temp = uicontrol(abr_FIG.handle,'callback','abr_analysis_HL(''temp'');','style','checkbox','Units','normalized','position',[0.07 0.08-shift 0.0630 .03],'String','Template','Value',0,'BackgroundColor',[0.8549 0.8549 0.8549]);
...
abr_FIG.push.peak1 = uicontrol(abr_FIG.handle,'callback','abr_analysis_HL(''peak1'');','style','togglebutton','Units','normalized','position',[0.35 0.21 0.02125 0.03],'string','p1');
abr_FIG.push.trou1 = uicontrol(abr_FIG.handle,'callback','abr_analysis_HL(''trou1'');','style','togglebutton','Units','normalized','position',[0.35 0.175 0.02125 0.03],'string','n1');
abr_FIG.push.peak2 = uicontrol(abr_FIG.handle,'callback','abr_analysis_HL(''peak2'');','style','togglebutton','Units','normalized','position',[0.37625 0.21 0.02125 0.03],'string','p2');
abr_FIG.push.trou2 = uicontrol(abr_FIG.handle,'callback','abr_analysis_HL(''trou2'');','style','togglebutton','Units','normalized','position',[0.37625 0.175 0.02125 0.03],'string','n2');
abr_FIG.push.peak3 = uicontrol(abr_FIG.handle,'callback','abr_analysis_HL(''peak3'');','style','togglebutton','Units','normalized','position',[0.4024 0.21 0.02125 0.03],'string','p3');
abr_FIG.push.trou3 = uicontrol(abr_FIG.handle,'callback','abr_analysis_HL(''trou3'');','style','togglebutton','Units','normalized','position',[0.4024 0.175 0.02125 0.03],'string','n3');
abr_FIG.push.peak4 = uicontrol(abr_FIG.handle,'callback','abr_analysis_HL(''peak4'');','style','togglebutton','Units','normalized','position',[0.4286 0.21 0.02125 0.03],'string','p4');
abr_FIG.push.trou4 = uicontrol(abr_FIG.handle,'callback','abr_analysis_HL(''trou4'');','style','togglebutton','Units','normalized','position',[0.4286 0.175 0.02125 0.03],'string','n4');
abr_FIG.push.peak5 = uicontrol(abr_FIG.handle,'callback','abr_analysis_HL(''peak5'');','style','togglebutton','Units','normalized','position',[0.4548 0.21 0.02125 0.03],'string','p5');
abr_FIG.push.trou5 = uicontrol(abr_FIG.handle,'callback','abr_analysis_HL(''trou5'');','style','togglebutton','Units','normalized','position',[0.4548 0.175 0.02125 0.03],'string','n5');
...
han.viewraw = uicontrol(abr_FIG.handle,'callback','abr_analysis_HL(''viewraw'');','style','checkbox','Units','normalized','position',[0.35 0.14 0.063 0.03],'String','Raw Data','Value',0,'BackgroundColor',[0.8549 0.8549 0.8549]);
...
%Print push button
abr_FIG.push.print   = uicontrol(abr_FIG.handle,'callback','abr_analysis_HL(''print'');','style','pushbutton','Units','normalized','position',[0.35 0.085 0.1260 .03],'string','Print');
...
axis off;
text(0.34,0.255,'Select Peaks:','Fontsize',10,'horizontalalignment','left','VerticalAlignment','middle');
text(0.27,0.40,'dB SPL','FontSize',12,'horizontalalignment','center','VerticalAlignment','middle','color','k')
text(0.5-0.02*0.33,0.945,'dB SPL','FontSize',10,'horizontalalignment','left','VerticalAlignment','middle','color','b')
text(0.5+0.92*0.33,0.945,'(attn)','FontSize',10,'horizontalalignment','left','VerticalAlignment','middle','color','k')
...
text(.2,.24-shift,'Template Left (ms):','fontsize',10,'color','k','horizontalalignment','left','VerticalAlignment','middle');
text(.2,.19-shift,'Template Right (ms):','fontsize',10,'color','k','horizontalalignment','left','VerticalAlignment','middle');
text(.2,.09-shift,'Number of Templates:','fontsize',10,'color','k','horizontalalignment','left','VerticalAlignment','middle');

abr_FIG.parm_txt(1)  = text(.8,.58-shift,num2str(abr_Stimuli.cal_pic),   'fontsize',10,'color','r','horizontalalignment','right','buttondownfcn','abr_analysis_HL(''stimulus'',1);');
abr_FIG.parm_txt(2)  = text(.8,.43-shift,num2str(abr_Stimuli.abr_pic),   'fontsize',10,'color','k','horizontalalignment','right','buttondownfcn','abr_analysis_HL(''stimulus'',2);');
abr_FIG.parm_txt(3)  = text(.8,.37-shift,num2str(abr_Stimuli.start),'fontsize',10,'color','b','horizontalalignment','right','buttondownfcn','abr_analysis_HL(''stimulus'',3);');
abr_FIG.parm_txt(4)  = text(.8,.32-shift,num2str(abr_Stimuli.end),  'fontsize',10,'color','b','horizontalalignment','right','buttondownfcn','abr_analysis_HL(''stimulus'',4);');
abr_FIG.parm_txt(5)  = text(.8,.24-shift,num2str(abr_Stimuli.start_template),'fontsize',10,'color','b','horizontalalignment','right','buttondownfcn','abr_analysis_HL(''stimulus'',5);');
abr_FIG.parm_txt(6)  = text(.8,.19-shift,num2str(abr_Stimuli.end_template),  'fontsize',10,'color','b','horizontalalignment','right','buttondownfcn','abr_analysis_HL(''stimulus'',6);');
...
%% Added by SP
freq_load.x= 0.3;
freq_load.width= 0.028;
freq_load.height= 0.025;
...
abr_FIG.push.freq500 = uicontrol(abr_FIG.handle,'callback','abr_analysis_HL(''freq_proc500'',0.5);','style','togglebutton','Units','normalized','position',...
    [freq_load.x 0.28 freq_load.width freq_load.height],'string','0.5 kHz');
abr_FIG.push.freq1k = uicontrol(abr_FIG.handle,'callback','abr_analysis_HL(''freq_proc1k'',1);','style','togglebutton','Units','normalized','position',...
    [freq_load.x 0.245 freq_load.width freq_load.height],'string','1 kHz');
abr_FIG.push.freq2k = uicontrol(abr_FIG.handle,'callback','abr_analysis_HL(''freq_proc2k'',2);','style','togglebutton','Units','normalized','position',...
    [freq_load.x 0.21 freq_load.width freq_load.height],'string','2 kHz');
abr_FIG.push.freq4k = uicontrol(abr_FIG.handle,'callback','abr_analysis_HL(''freq_proc4k'',4);','style','togglebutton','Units','normalized','position',...
    [freq_load.x 0.175 freq_load.width freq_load.height],'string','4 kHz');
abr_FIG.push.freq8k = uicontrol(abr_FIG.handle,'callback','abr_analysis_HL(''freq_proc8k'',8);','style','togglebutton','Units','normalized','position',...
    [freq_load.x 0.14 freq_load.width freq_load.height],'string','8 kHz');
...
text(.2,.5-shift,'Max dB SPL:','fontsize',10,'color','k','horizontalalignment','left','VerticalAlignment','middle');
abr_FIG.parm_txt(8)  = text(.8,.5-shift,num2str(abr_Stimuli.maxdB2analyze),'fontsize',10,'color','b','horizontalalignment','right','buttondownfcn','abr_analysis_HL(''stimulus'',8);');
