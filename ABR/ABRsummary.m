...
if exist(outpath,"dir")
    ...
    if strcmp(analysis_type1,'Thresholds')
        ...
        plot_ind_abr(abr_out,analysis_type1,colors,shapes,Conds2Run,Chins2Run,ChinIND,CondIND,outpath,ylimits_ind_threshold,[],[])
...
if average_flag == 1
    if strcmp(analysis_type1,'Thresholds')
        ...
        [average,idx] = avg_abr(abr_f,abr_thresholds,Chins2Run,Conds2Run,fig_num_avg,colors,shapes,idx_plot_relative,analysis_type1,[]);
        % Plot average lines
    ...
    elseif strcmp(analysis_type1,'Peaks')
        if strcmp(analysis_type2,'Manual')
            ...
            plot_avg_abr(average,analysis_type1,colors,shapes,idx,Conds2Run,outpath,filename,fig_num_avg,[],idx_plot_relative,'Latency')
        elseif strcmp(analysis_type2,'DTW')
            % Peak-to-peak amplitude
            fig_num_avg = ((ChinIND - 1) * length(Conds2Run) + CondIND)+1;
            [average,idx] = avg_abr(abr_peaks_level,abr_peaks_amp,Chins2Run,Conds2Run,fig_num_avg,colors,shapes,idx_plot_relative,analysis_type1,'Amplitude');
