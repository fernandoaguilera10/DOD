...
if average_flag == 1
    ...
    average = avg_efr_dAM(efr_trajectory,efr_dAMpower_smooth,efr_NFpower_smooth,Chins2Run,Conds2Run,all_Conds2Run,fig_num_avg,colors,shapes,idx_plot_relative,subject_idx,conds_idx);
    % Plot average lines
