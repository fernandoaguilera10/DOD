...
if exist(outpath,"dir")
    ...
    plot_ind_oae(data,'EPL','DPOAE',colors,Conds2Run,Chins2Run,ChinIND,CondIND,outpath,fig_num_ind,ylimits_ind,shapes)
    % PLOTTING SPL
    ...
    plot_ind_oae(data,'SPL','DPOAE',colors,Conds2Run,Chins2Run,ChinIND,CondIND,outpath,fig_num_ind+1,ylimits_ind,shapes)
    cd(cwd);
else
