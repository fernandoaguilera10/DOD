...
if average_flag == 1
    ...
    plot_avg_oae(average_epl,'EPL','SFOAE',colors,idx,Chins2Run,Conds2Run,outpath,filename_epl,fig_num_avg+1,ylimits_avg,idx_plot_relative,shapes)
    filename_spl = 'SFOAEswept_Average_SPL';
    plot_avg_oae(average_spl,'SPL','SFOAE',colors,idx,Chins2Run,Conds2Run,outpath,filename_spl,fig_num_avg+2,ylimits_avg,idx_plot_relative,shapes);
end
cd(cwd);
end