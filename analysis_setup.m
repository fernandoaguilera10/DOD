...
%     options.outputDir = strcat(OUTdir,filesep,'Reports');
%     if ~isempty(EXPname2)
%         filename = [EXPname,'_',EXPname2,'_Report'];
%     elseif ~isempty(EXPname3)
%         filename = [EXPname,'_',EXPname2,'_',EXPname3,'_Report'];
%     end
%     publish('analysis_setup.m',options);
end